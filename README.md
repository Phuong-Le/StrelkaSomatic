...
**nf-core/strelkasomatic** is a bioinformatics pipeline that ...
...
```bash
nextflow run nf-core/strelkasomatic \
...
For more details and further functionality, please refer to the [usage documentation](https://nf-co.re/strelkasomatic/usage) and the [parameter documentation](https://nf-co.re/strelkasomatic/parameters).
...
For further information or help, don't hesitate to get in touch on the [Slack `#strelkasomatic` channel](https://nfcore.slack.com/channels/strelkasomatic) (you can join with [this invite](https://nf-co.re/join/slack)).

## Citations

<!-- TODO nf-core: Add citation for pipeline after first release. Uncomment lines below and update Zenodo doi and badge at the top of this file. -->
<!-- If you use nf-core/strelkasomatic for your analysis, please cite it using the following doi: [10.5281/zenodo.XXXXXX](https://doi.org/10.5281/zenodo.XXXXXX) -->
